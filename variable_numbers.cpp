//
// Created by schperberg on 12/17/23.
//
//
...
void tutorial4(){
    ...
    // All the same numbers but in different formats
   ...
   */
    ...
    //Functional Initialization
     ...
     int narrowing_conversion_functional (2.9); //takes fractional number and chops it off so it is 2. Use curly braces because it will give error,
     // while paranthesis do not
    ...
    */
    ...
    //Check the size with sizeof (in terms of bytes)
